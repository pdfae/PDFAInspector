...
def displaysummary(request, uid):
	...
	output = ""
		...
		output.append("<b>Links:</b><br><table class = \"fancy\"><tr><th>Title</th><th>Pass</th><th>Fail</th><th>Warning</th><th>Manual Inspection</th></tr><tr><td><center>Number of Links</center></td><td colspan="3"><center>" + unicode(numLinks) + "</center></td></tr>")
